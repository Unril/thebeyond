...
external interface MatterBodyConfig {
    ...
    var shape: dynamic /* String? | Phaser.Types.Physics.Matter.MatterSetBodyConfig? */
        get() = definedExternally
        set(value) = definedExternally
...
inline operator fun MatterBodyRenderConfig.get(key: String): Number? = asDynamic()[key]


inline operator fun MatterBodyRenderConfig.set(key: String, value: Number?) {
    asDynamic()[key] = value
}
...
inline operator fun MatterWorldConfig.get(key: String): Any? = asDynamic()[key]


inline operator fun MatterWorldConfig.set(key: String, value: Number?) {
    asDynamic()[key] = value
}


inline operator fun MatterWorldConfig.set(key: String, value: Boolean?) {
    asDynamic()[key] = value
}
