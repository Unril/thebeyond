...
typealias GetActiveCallback = (target: Any, key: String, value: Number, targetIndex: Number, totalTargets: Number, tween: Tween) -> Unit

typealias GetEndCallback = (target: Any, key: String, value: Number, targetIndex: Number, totalTargets: Number, tween: Tween) -> Unit

typealias GetStartCallback = (target: Any, key: String, value: Number, targetIndex: Number, totalTargets: Number, tween: Tween) -> Unit
