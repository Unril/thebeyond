...
external var CIRCLE: Number

external var ELLIPSE: Number

external var LINE: Number

external var POINT: Number

external var POLYGON: Number

external var RECTANGLE: Number

external var TRIANGLE: Number
...
open external class Line(
    ...
    companion object {
        ...
        fun BresenhamPoints(
            line: Line,
            stepRate: Number = definedExternally,
            results: Array<Vector2Like> = definedExternally
        ): Array<Vector2Like>
        ...
        fun <O : Array<Point>> GetEasedPoints(
            line: Line,
            ease: String,
            quantity: Number,
            collinearThreshold: Number = definedExternally,
            easeParams: Array<Number> = definedExternally
        ): O
...
open external class Point(x: Number = definedExternally, y: Number = definedExternally) {
    ...
    companion object {
        ...
        fun <O : Point> Interpolate(
            pointA: Point,
            pointB: Point,
            t: Number = definedExternally,
            out: O = definedExternally
        ): O
...
open external class Polygon {
    constructor(points: String = definedExternally)
    constructor()
    constructor(points: Array<Number> = definedExternally)
    constructor(points: Array<Vector2Like> = definedExternally)

    open val type: Number
    open var area: Number
    open var points: Array<Point>
    open fun contains(x: Number, y: Number): Boolean
    open fun setTo(points: String = definedExternally): Polygon /* this */
    open fun setTo(): Polygon /* this */
    open fun setTo(points: Array<Number> = definedExternally): Polygon /* this */
    open fun setTo(points: Array<Vector2Like> = definedExternally): Polygon /* this */
    ...
    companion object {
        ...
        fun Earcut(
            data: Array<Number>,
            holeIndices: Array<Number> = definedExternally,
            dimensions: Number = definedExternally
        ): Array<Number>
        ...
        fun <O : Polygon> Simplify(
            polygon: O,
            tolerance: Number = definedExternally,
            highestQuality: Boolean = definedExternally
        ): O

        fun <O : Polygon> Smooth(polygon: O): O
        fun <O : Polygon> Translate(polygon: O, x: Number, y: Number): O
    }
}
...
open external class Rectangle(
    ...
    companion object {
        ...
        fun <O : Array<Point>> MarchingAnts(
            rect: Rectangle,
        ...
        fun <O : Point> PerimeterPoint(rectangle: Rectangle, angle: Number, out: O = definedExternally): O
...
open external class Triangle(
    ...
    companion object {
        ...
        fun <O : Array<Triangle>> BuildFromPolygon(
            data: Array<Any>,
            holes: Array<Any> = definedExternally,
        ...
        fun <O : Triangle> CenterOn(
            triangle: O,
            x: Number,
            y: Number,
            centerFunc: CenterFunction = definedExternally
        ): O
        ...
        fun ContainsArray(
            triangle: Triangle,
            points: Array<Point>,
            returnFirst: Boolean = definedExternally,
        ...
        fun <O : Point> GetPoints(triangle: Triangle, quantity: Number, stepRate: Number, out: O = definedExternally): O
