...
external fun CreateGroupLayer(
    json: Any?,
    currentl: Any? = definedExternally,
    parentstate: Any? = definedExternally
): Any?
...
external fun ParseWangsets(wangsets: Array<Any?>, datas: Any?): Any?
