...
external open class Bodies {
    companion object {
        fun circle(
            ...
            y: Number,
            radius: Number,
            options: IBodyDefinition = definedExternally,
        ...
        fun polygon(
            ...
            sides: Number,
            radius: Number,
            options: IChamferableBodyDefinition = definedExternally
        ): BodyType
...
external open class Composite {
    companion object {
        ...
        fun get(
            ...
            id: Number,
            type: String
        ): dynamic /* BodyType | CompositeType | ConstraintType */

        fun move(
            compositeA: CompositeType,
            objects: Array<Any /* BodyType | CompositeType | ConstraintType */>,
        ...
        fun setModified(
            composite: CompositeType,
            isModified: Boolean,
            updateParents: Boolean = definedExternally,
...
external open class Engine {
    ...
    companion object {
        ...
        fun create(
            element: IEngineDefinition = definedExternally,
            options: IEngineDefinition = definedExternally
        ): Engine
...
external open class Plugin {
    ...
    companion object {
        ...
        fun isFor(plugin: Plugin, module: `T$26`): Boolean
        fun use(module: `T$27`, plugins: Array<Any /* Plugin | String */>)
        fun dependencies(module: `T$24`, tracked: `T$28` = definedExternally): dynamic /* `T$29`? | String? */
        fun dependencies(module: `T$25`, tracked: `T$28` = definedExternally): dynamic /* `T$29`? | String? */
        fun dependencies(module: String, tracked: `T$28` = definedExternally): dynamic /* `T$29`? | String? */
        fun dependencyParse(dependency: `T$24`): `T$24`
        fun dependencyParse(dependency: `T$25`): `T$24`
        fun dependencyParse(dependency: String): `T$24`
        fun versionParse(range: String): `T$30`
        fun versionSatisfies(version: String, range: String): Boolean
    }
}

external open class Collision {
    open fun create(bodyA: BodyType, bodyB: BodyType): Any
    open fun collides(bodyA: BodyType, bodyB: BodyType, pairs: Pairs): Any
}
